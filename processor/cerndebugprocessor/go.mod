module github.com/open-telemetry/opentelemetry-collector-contrib/processor/cerndebugprocessor
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/processor/cerndebugprocessor => ./
