...
package cerndebugprocessor // import "github.com/open-telemetry/opentelemetry-collector-contrib/processor/debugprocessor"
...
type Config struct {
	...
	// through the debug by this processor in messages per second. Defaults to 1.
